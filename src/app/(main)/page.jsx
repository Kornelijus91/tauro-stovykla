			...
			<section className='w-full bg-bgColor-light flex justify-center py-20'>
				<div className='w-full md:w-[80rem] px-6 xl:px-0 grid grid-cols-1 lg:grid-cols-2 gap-32'>
					...
					>
						...
						<Link href="/apiemus" className='text-fontColor-dark hover:text-fontColor-button underline'>Plačiau...</Link>
					</section>
					<section
						className='
							flex
					...
					>
						...
						<Link href="/paslaugos" className='text-fontColor-dark hover:text-fontColor-button underline'>Plačiau...</Link>
					</section>
				</div>
			</section>
