...
const Footer = () => {
    return (
        <footer className='w-full bg-fontColor-dark flex flex-col items-center text-bgColor-light font-extralight'>
            <DividerInverted className='block h-4 md:h-10 w-full text-bgColor-light'/>
