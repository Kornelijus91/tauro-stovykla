...
const Galerija = () => {
    ...
    return (
        <div>
            <h2 className='font-TitleFont font-bold text-4xl md:text-4xl mb-2 after:mt-2 after:w-full after:h-px flex flex-col justify-between after:bg-fontColor-dark after:rounded-full'>Galerija</h2>
